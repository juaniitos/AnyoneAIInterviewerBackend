...
- Saves timestamped note to `.planning/notes/` (or `/Users/diegocaminor/Documents/proyectos/anyone-ai/final-project/AnyoneAIInterviewerBackend/.claude/notes/` globally)
