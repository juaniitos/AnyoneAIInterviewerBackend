...
```bash
# Get state snapshot
node "/Users/diegocaminor/Documents/proyectos/anyone-ai/final-project/AnyoneAIInterviewerBackend/.codex/get-shit-done/bin/gsd-tools.cjs" state json 2>/dev/null || echo "{}"
```
