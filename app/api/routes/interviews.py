...
@router.post("/{interview_id}/answers", response_model=schemas.AnswerRead, status_code=status.HTTP_201_CREATED)
...
@router.post("/{interview_id}/finish", response_model=schemas.InterviewRead)
